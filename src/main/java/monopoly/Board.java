...
public class Board {
    ...
    private void initBoard(){
        ...
        fields.add(new Trainstation("Südbahnhof", trainStations));
        ...
        fields.add(new PublicInfrastructure("Elektrizitätswerk", trainStations));
        fields.add(new Estate("Hafenstraße", propertyGroup, new int[]{9999}));
        fields.add(new Estate("Neue Straße", propertyGroup, new int[]{9999}));
        fields.add(new Trainstation("Westbahnhof", trainStations));
        ...
        fields.add(new Trainstation("Nordbahnhof", trainStations));
        ...
        fields.add(new PublicInfrastructure("Wasserwerk", works));
        ...
        fields.add(new Trainstation("Hauptbahnhof", trainStations));
        fields.add(new ActionField()); //todo Ereigniskarte
